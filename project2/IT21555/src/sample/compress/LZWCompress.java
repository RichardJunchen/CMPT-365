...
public class LZWCompress {
    ...
    public void LZW_Compress(String input, String output) throws IOException {
        ...
        dictionaryChar = new String[4096];
        for (int i = 0; i < 256; i++) {
            table.put(Character.toString((char) i), i);
            dictionaryChar[i] = Character.toString((char) i);
        }
        count = 256;
    ...
    public void LZW_Decompress(String input, String output) throws IOException {
        ...
        try {
            ...
            onleft = !onleft;
            out.writeBytes(dictionaryChar[priorword]);
            ...
            while (true) {
                ...
                if (currword >= count) {
                    ...
                    if (count < 4096)
                        dictionaryChar[count] = dictionaryChar[priorword]
                                + dictionaryChar[priorword].charAt(0);
                    count++;
                    out.writeBytes(dictionaryChar[priorword]
                            + dictionaryChar[priorword].charAt(0));
                } else {
                    ...
                    if (count < 4096)
                        dictionaryChar[count] = dictionaryChar[priorword]
                                + dictionaryChar[currword].charAt(0);
                    count++;
                    out.writeBytes(dictionaryChar[currword]);
                }
                priorword = currword;
            }
    ...
    public static void main(String[] args) throws IOException {
        ...
        lzw.LZW_Compress("tiger.tif", "tiger1.tif");
        lzw.LZW_Decompress("tiger1.tif", "tiger2.tif");
//
